...
WC.data <- left_join(match.data, mw.data, by=c("Year" = "Year", "Team.Initials" = "Team")) # left outer join as we want to keep 2018 data
...
WC.data <- left_join(WC.data, mw.data, by=c("Year" = "Year", "Opponent.Initials" = "Team")) # left outer join as we want to keep 2018 data
WC.data <- left_join(WC.data, ranking.data, by=c("Year" = "Year", "Opponent.Initials" = "country_abrv"))
l_bound = (length(WC.data) -4) /2
